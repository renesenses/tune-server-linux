...
if TYPE_CHECKING:
    ...
    from tune_server.db.repository import AlbumRepo, ArtistRepo, PlaylistRepo, PlayQueueRepo, RadioFavoriteRepo, RadioStationRepo, TrackCreditRepo, TrackRepo, ZoneRepo
