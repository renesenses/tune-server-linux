...
from tune_server.api.routes import devices, library, network, playback, playlists, radios, recording, search, streaming, system, zones
...
def create_api_app() -> FastAPI:
    ...
    app.include_router(recording.recordings_router, prefix="/api/v1")
