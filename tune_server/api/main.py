...
from tune_server.api.routes import devices, library, metadata_manager, network, playback, playlist_manager, playlists, podcasts, profiles, radio_favorites, radios, search, streaming, system, zone_manager, zones
...
def create_api_app() -> FastAPI:
    ...
    app.include_router(metadata_manager.router, prefix="/api/v1")
    @app.websocket("/ws")
