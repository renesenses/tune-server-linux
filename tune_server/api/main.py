...
from tune_server.api.routes import artist_metadata, devices, dj, library, network, party, playback, playlist_manager, playlists, podcasts, profiles, radio_favorites, radios, search, snapcast, sonos, spotify_connect, streaming, system, zone_manager, zones
...
def create_api_app() -> FastAPI:
    ...
    app.include_router(snapcast.router, prefix="/api/v1")
    app.include_router(sonos.router, prefix="/api/v1")
