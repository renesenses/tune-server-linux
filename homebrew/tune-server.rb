class TuneServer < Formula
  ...
  url "https://github.com/renesenses/tune-server-linux/archive/refs/tags/v0.7.90.tar.gz"
  ...
  resource "web-client" do
    url "https://github.com/renesenses/tune-web-client/archive/refs/tags/v0.7.90.tar.gz"
    sha256 :no_check
  end
